...
from typing import Any, TypeGuard, Union, cast, TYPE_CHECKING, Protocol, Literal
...
def safe_find_all(element: PageElement, *args: Any, **kwargs: Any) -> "ResultSet[PageElement]":
